...
const char* serverURL = "https://<http://im4.julianreusser.ch>/api/load.php";  // Server-Adresse: hier kann http oder https stehen, aber nicht ohne, zB. https://im4.physco.dorfkneipe.ch/api/load.php
